...
The following table contains the commands executed in the process and the parent process for each rule activated during the test. The table also shows each command's username, event action, and event severity.
